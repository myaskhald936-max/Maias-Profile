...
const translations = {
    "en": {
        ...
        "project.description1": "A unified communication application that combines instant messaging, voice and video calls, and email in a single, integrated interface.",
        "project.description2": "A charitable platform aimed at building and serving mosques by supporting projects, receiving donations, and enabling volunteers.",
        "project.description3": "A complete online bookstore with a delivery system, advanced search features, and personalized recommendations.",
        "project.description4": "An online store for selling laptops, offering an easy and diverse shopping experience with a clean and smooth user interface.",
        "project.description5": "An advanced administrative platform for tracking and analyzing cryptocurrency data and financial investments.",
        "project.description6": "A specialized platform for selling Apple phones, showcasing the latest iPhone models with clear specifications and attractive design.",
    ...
    "ar": {
        ...
        "project.description1": "تطبيق اتصالات موحد يجمع بين المراسلة الفورية والمكالمات الصوتية والمرئية والبريد الإلكتروني في واجهة واحدة متكاملة.",
        "project.description2": "منصة خيرية تهدف إلى بناء المساجد وخدمتها من خلال دعم المشاريع، وتلقي التبرعات، وتمكين المتطوعين.",
        "project.description3": "مكتبة إلكترونية متكاملة مزودة بنظام توصيل، وميزات بحث متقدمة، وتوصيات شخصية.",
        "project.description4": "متجر إلكتروني لبيع أجهزة الكمبيوتر المحمولة، يوفر تجربة تسوق سهلة ومتنوعة مع واجهة مستخدم نظيفة وسلسة.",
        "project.description5": "منصة إدارية متطورة لتتبع وتحليل بيانات العملات المشفرة والاستثمارات المالية.",
        "project.description6": "منصة متخصصة لبيع هواتف آبل، تعرض أحدث طرازات آيفون بمواصفات واضحة وتصميم جذاب.",
